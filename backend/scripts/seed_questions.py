        ...
        for q_type in question_types:
            ...
            for i in range(1, 11):
                ...
                if q_type == "MULTIPLE_CHOICE" or q_type == "IMAGE_MULTIPLE_CHOICE":
                    options = [
                        {"option_label": "A", "option_text": f"Option A for {q_type} {i}", "is_correct": i % 4 == 1},
                        {"option_label": "B", "option_text": f"Option B for {q_type} {i}", "is_correct": i % 4 == 2},
                        {"option_label": "C", "option_text": f"Option C for {q_type} {i}", "is_correct": i % 4 == 3},
                        {"option_label": "D", "option_text": f"Option D for {q_type} {i}", "is_correct": i % 4 == 0}
                    ]
                    ...
                    ans_text = f"Analysis of the visual data in {subject} image question {i}."
