...
from app.locations.schemas import StateRead, DistrictRead, DistrictCreate, DistrictUpdate
...
def create_district(state_id: int, payload: DistrictCreate, db: Session = Depends(get_db)):
    """
