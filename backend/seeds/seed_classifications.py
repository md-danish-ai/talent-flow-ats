...
CLASSIFICATIONS = [
    ...
    {"type": "family_relation", "code": "FATHER",
        "name": "Father", "sort_order": 26},
    {"type": "family_relation", "code": "MOTHER",
        "name": "Mother", "sort_order": 27},
    {"type": "family_relation", "code": "HUSBAND",
        "name": "Husband", "sort_order": 28},
    {"type": "family_relation", "code": "WIFE", "name": "Wife", "sort_order": 29},
    {"type": "family_relation", "code": "SON", "name": "Son", "sort_order": 30},
    {"type": "family_relation", "code": "DAUGHTER",
        "name": "Daughter", "sort_order": 31},
    {"type": "family_relation", "code": "BROTHER",
        "name": "Brother", "sort_order": 32},
    {"type": "family_relation", "code": "SISTER",
        "name": "Sister", "sort_order": 33},
    {"type": "family_relation", "code": "GUARDIAN",
        "name": "Guardian", "sort_order": 34},
    # 6. Marital Status (41 - 45)
    {"type": "marital_status", "code": "SINGLE",
        "name": "Single", "sort_order": 35},
    {"type": "marital_status", "code": "MARRIED",
        "name": "Married", "sort_order": 36},
    {"type": "marital_status", "code": "DIVORCED",
        "name": "Divorced", "sort_order": 37},
    {"type": "marital_status", "code": "WIDOWED",
        "name": "Widowed", "sort_order": 38},
    {"type": "marital_status", "code": "SEPARATED",
        "name": "Separated", "sort_order": 39},
    # 7. Education Category (46 - 51)
    {"type": "education_category", "code": "HIGH_SCHOOL",
        "name": "10th / High School", "sort_order": 40},
    {"type": "education_category", "code": "INTERMEDIATE",
        "name": "12th / Intermediate", "sort_order": 41},
    {"type": "education_category", "code": "DIPLOMA",
        "name": "Diploma", "sort_order": 42},
    {"type": "education_category", "code": "BACHELORS",
        "name": "Bachelor's Degree", "sort_order": 43},
    {"type": "education_category", "code": "MASTERS",
        "name": "Master's Degree", "sort_order": 44},
    {"type": "education_category", "code": "DOCTORATE",
        "name": "Ph.D. / Doctorate", "sort_order": 45},
    # 8. Language (52 - 53)
    {"type": "language", "code": "ENGLISH", "name": "English", "sort_order": 46},
    {"type": "language", "code": "HINDI", "name": "Hindi", "sort_order": 47},
    # 9. Religion (54 - 60)
    {"type": "religion", "code": "HINDUISM", "name": "Hinduism", "sort_order": 48},
    {"type": "religion", "code": "ISLAM", "name": "Islam", "sort_order": 49},
    {"type": "religion", "code": "CHRISTIANITY",
        "name": "Christianity", "sort_order": 50},
    {"type": "religion", "code": "SIKHISM", "name": "Sikhism", "sort_order": 51},
    {"type": "religion", "code": "BUDDHISM", "name": "Buddhism", "sort_order": 52},
    {"type": "religion", "code": "JAINISM", "name": "Jainism", "sort_order": 53},
    {"type": "religion", "code": "OTHER", "name": "Other", "sort_order": 54},
    # 10. Social Category (61 - 65)
    {"type": "social_category", "code": "GENERAL",
        "name": "General", "sort_order": 55},
    {"type": "social_category", "code": "OBC", "name": "OBC", "sort_order": 56},
    {"type": "social_category", "code": "SC", "name": "SC", "sort_order": 57},
    {"type": "social_category", "code": "ST", "name": "ST", "sort_order": 58},
    {"type": "social_category", "code": "EWS", "name": "EWS", "sort_order": 59},
    # 11. Blood Group (66 - 73)
    {"type": "blood_group", "code": "A_POSITIVE", "name": "A+", "sort_order": 60},
    {"type": "blood_group", "code": "A_NEGATIVE", "name": "A-", "sort_order": 61},
    {"type": "blood_group", "code": "B_POSITIVE", "name": "B+", "sort_order": 62},
    {"type": "blood_group", "code": "B_NEGATIVE", "name": "B-", "sort_order": 63},
    {"type": "blood_group", "code": "O_POSITIVE", "name": "O+", "sort_order": 64},
    {"type": "blood_group", "code": "O_NEGATIVE", "name": "O-", "sort_order": 65},
    {"type": "blood_group", "code": "AB_POSITIVE", "name": "AB+", "sort_order": 66},
    {"type": "blood_group", "code": "AB_NEGATIVE", "name": "AB-", "sort_order": 67},
    # 12. Employment Type (74 - 77)
    {"type": "employment_type", "code": "FULL_TIME",
        "name": "Full-time", "sort_order": 68},
    {"type": "employment_type", "code": "PART_TIME",
        "name": "Part-time", "sort_order": 69},
    {"type": "employment_type", "code": "CONTRACT",
        "name": "Contract", "sort_order": 70},
    {"type": "employment_type", "code": "INTERNSHIP",
        "name": "Internship", "sort_order": 71},
]
