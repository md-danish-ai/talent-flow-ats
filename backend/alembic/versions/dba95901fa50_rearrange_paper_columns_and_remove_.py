...
def upgrade() -> None:
    ...
    op.execute(
        "ALTER TABLE interview_attempts DROP CONSTRAINT IF EXISTS interview_attempts_paper_id_fkey"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "subject_ids_data", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "question_id", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            "subject_id", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "question_id", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
