...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=30), server_default="started", nullable=False
        ),
        ...
        sa.Column(
            "unattempted_count", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column("obtained_marks", sa.Numeric(precision=10, scale=2), nullable=True),
        sa.Column(
            "is_auto_submitted", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP(),
    ...
    op.create_index(
        op.f("ix_interview_attempts_id"), "interview_attempts", ["id"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "is_auto_saved", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
            "saved_at",
            sa.TIMESTAMP(),
        ...
        sa.ForeignKeyConstraint(
            ["attempt_id"], ["interview_attempts.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["question_id"],
            ["questions.id"],
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_interview_attempt_answers_id"), table_name="interview_attempt_answers"
    )
