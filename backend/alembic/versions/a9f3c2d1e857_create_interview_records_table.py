...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "unattempted_count", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column("total_marks", sa.Numeric(10, 2), nullable=False, server_default="0"),
        sa.Column(
            "obtained_marks", sa.Numeric(10, 2), nullable=False, server_default="0"
        ),
        ...
        sa.Column(
            "is_auto_submitted", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "responses",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.create_index(
        "ix_interview_records_id", "interview_records", ["id"], unique=False
    )
    op.create_index(
        "ix_interview_records_user_id", "interview_records", ["user_id"], unique=False
    )
    op.create_index(
        "ix_interview_records_paper_id", "interview_records", ["paper_id"], unique=False
    )
