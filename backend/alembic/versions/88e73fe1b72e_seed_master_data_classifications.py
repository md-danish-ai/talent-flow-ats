...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        ('education_category', 'GRADUATION', 'Graduation', 48, true),
        ('education_category', 'POST_GRADUATION', 'Post Graduation', 49, true),
        ('education_category', 'DOCTORATE', 'Ph.D. / Doctorate', 50, true),
