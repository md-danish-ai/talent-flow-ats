...
type LeadGenerationListingFilters = {
  search: string;
  subject: string;
  examLevel: string;
  marks: string;
...
export function LeadGenerationClient() {
  ...
  const {
    ...
    toastMessage: "Lead generation list refreshed successfully",
  });
  ...
  return (
    <PageContainer animate>
      <MainCard
        ...
        subtitle="Manage candidate demographic and survey questionnaire fields."
      ...
      <QuestionCreationModal
        ...
        renderManualForm={(onSuccess) => (
          <LeadGenerationForm onSuccess={onSuccess} />
        )}
      />
