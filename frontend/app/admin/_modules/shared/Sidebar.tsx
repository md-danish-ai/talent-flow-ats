        ...
        `}
                ...
                <div className="absolute left-full ml-2 w-48 bg-white border border-slate-200 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 overflow-hidden">
                    <div className="p-3 border-b border-slate-100 bg-slate-50">
                        <span className="text-xs font-bold text-slate-900 uppercase tracking-wider">{section.title}</span>
                    </div>
                    <div className="p-1">
      ...
      `}
            >
                <div className="flex items-center gap-3">
                    <span className={isSectionActive ? 'text-[#F96331]' : 'text-slate-400 group-hover:text-slate-600'}>
                        {section.icon}
                    </span>
    ...
    return (
      ...
      `}>
          ...
          `}>
                    ...
                    <nav className={`hidden min-[900px]:block flex-1 overflow-y-auto py-6 space-y-2
