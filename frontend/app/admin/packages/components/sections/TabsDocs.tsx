      ...
      <div className="grid grid-cols-1 gap-y-12">
        <DocSubSection title="Variants (Horizontal)">
          <div className="space-y-8 w-full">
            <div className="space-y-2">
              <p className="text-xs font-bold uppercase text-muted-foreground/60 tracking-widest">
                Pills (Default)
              </p>
              <Tabs
                tabs={basicTabs}
        ...
        <DocSubSection title="Orientation (Vertical)">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
            <div className="space-y-2">
              <p className="text-xs font-bold uppercase text-muted-foreground/60 tracking-widest mb-4">
                Vertical Pills
              </p>
