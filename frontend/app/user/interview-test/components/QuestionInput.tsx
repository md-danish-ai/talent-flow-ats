    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 pt-2">
        {groups.map((group) => (
          <div
            key={group.title}
            className="flex flex-col rounded-xl border border-border bg-muted/10 overflow-hidden"
          >
        ...
        <div className="relative group/source">
          ...
          <div className="relative rounded-2xl border border-border bg-card/80 backdrop-blur-md p-7 sm:p-8 select-none overflow-hidden shadow-2xl shadow-brand-primary/5">
            <div className="absolute -top-10 -right-4 p-3 opacity-5 group-hover/source:opacity-10 transition-opacity pointer-events-none">
              <Typography className="font-serif text-[180px] leading-none">
                &quot;
              </Typography>
            </div>
            <Typography
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border border-border bg-muted/10 p-1 relative pt-5 shadow-sm">
            <div className="absolute top-0 left-6 -translate-y-1/2 flex items-center gap-2 bg-background px-3 py-1 rounded-full border border-border shadow-sm">
              ...
              <span className="text-[10px] uppercase font-black tracking-widest text-muted-foreground mr-1">
                Passage Paragraph
              </span>
            </div>
          ...
          <div className="rounded-2xl border border-border bg-muted/10 p-1 relative pt-5 shadow-sm">
            ...
            <div className="p-5 font-bold text-lg text-foreground tracking-tight">
              {question.questionText}
            </div>
          </div>
      ...
      {isFormType ? (
        <div className="rounded-xl border border-border bg-brand-primary/5 p-4 flex items-center gap-4">
          ...
          <div className="space-y-0.5 min-w-0">
            <Typography
              variant="body5"
              className="text-muted-foreground uppercase tracking-wider font-bold"
            >
              Target Source / URL
            </Typography>
            <Typography
              variant="body2"
              className="text-foreground font-bold break-all"
            >
              {question.questionText}
            </Typography>
          </div>
