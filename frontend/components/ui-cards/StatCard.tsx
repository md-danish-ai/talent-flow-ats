...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "bg-card p-6 border border-border/80 shadow-sm flex items-center gap-6 transition-all duration-300 hover:border-brand-primary/30 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden",
