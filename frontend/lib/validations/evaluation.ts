...
export const evaluationSchema = z.object({
  evaluation_data: z.object({
    ...
    "Domain Knowledge": z.string().min(1, "Domain Knowledge rating is required"),
    "Critical Thinking": z.string().min(1, "Critical Thinking rating is required"),
    ...
    "Learning Ability": z.string().min(1, "Learning Ability rating is required"),
  }),
